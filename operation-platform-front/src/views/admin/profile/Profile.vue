      ...
      >
        ...
        >
          ...
          <div class="profile-center-detail">
            <p>
              <a-icon type="link" /><a
                :href="options.mlnlco_url || 'none'"
                target="method"
              >{{ options.mlnlco_url || 'none' }}</a>
            </p>
            <p>
          ...
          <div class="general-profile">
            ...
            >
              <a-list-item>平台已经陪伴您 {{ statistics.postCount || 0 }} 天。</a-list-item>
              <a-list-item>您已经连续听歌 {{ statistics.categoryCount || 0 }} 天。</a-list-item>
              <a-list-item>累计添加了 {{ statistics.tagCount || 0 }} 个标签。</a-list-item>
              <a-list-item>累计获得了 {{ statistics.commentCount || 0 }} 条评论。</a-list-item>
              <a-list-item>累计创建了 {{ statistics.linkCount || 0 }} 个歌单。</a-list-item>
              <a-list-item>累计收藏了 {{ statistics.visitCount || 0 }}个歌单。</a-list-item>
