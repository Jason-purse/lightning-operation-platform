          ...
          <a-list :split="false">
            ...
            <a-list-item>
              <a-switch
                ...
                :defaultChecked="fixSidebar"
                @change="handleFixSidebar"
              />
              <a-list-item-meta>
                <div
                  slot="title"
...
export default {
  ...
  methods: {
    ...
    // 只有sideMenu才能设置fixed
    handleFixSidebar (fixed) {
      if (this.layoutMode === 'topmenu') {
        this.baseConfig.fixSidebar = false
        this.$store.dispatch('ToggleFixSidebar', false)
        return
      }
      this.baseConfig.fixSidebar = fixed
      this.$store.dispatch('ToggleFixSidebar', fixed)
    }
  }
}
</script>
