...
function getIcon(Component) {
    return (
        <Icon as={Component} width='20px' height='20px' color='inherit'/>
    )
}
...
export function SidebarLinks(props) {
    ...
    const activeRoute = (routeName) => {
        console.log(pathname.includes(routeName))
        return pathname.includes(routeName);
    };

    // this function creates the links from the secondary accordions (for example auth -> sign-in -> dashboard)
